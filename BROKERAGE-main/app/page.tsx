...
export default function Home() {
  ...
  // Company contact identifiers — editable, persisted to localStorage
              ...
              <>
                ...
                <div className="pdf-settings">
                  ...
                  <div className="pdf-settings__row">
                    ...
                    {/* Contact / Identifiers */}
                    <div className="pdf-settings__row">
                      <label htmlFor="companyPhoneInput" className="pdf-settings__label">Phone</label>
                      <input
                    ...
                    <div className="pdf-settings__row">
                      <label htmlFor="companyPANInput" className="pdf-settings__label">PAN No</label>
                      <input
                        id="companyPANInput"
                        type="text"
                        value={companyPAN}
                    ...
                    <div className="pdf-settings__row">
                      <label htmlFor="companyGSTInput" className="pdf-settings__label">GST No</label>
                      <input
                        id="companyGSTInput"
                        type="text"
                        value={companyGST}
